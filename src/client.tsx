  ...
  return React.createElement('div', { style: { padding: '4px 0' } },
    ...
    React.createElement('div', { style: { marginBottom: 8 } },
      ...
      React.createElement('p', { style: { margin: '0 0 6px', fontSize: 11, color: 'var(--dsw-alias-label-tertiary, #888)', lineHeight: 1.4 } },
        'Routed (model chooses next role) or pipeline (ordered chain with verify-gate). Each role carries roleTask + tasks [{id,title,acceptanceCriteria,status}]. Example: {"engineering":{"mode":"pipeline","roles":[{"name":"planner","presetId":"subagent-slim","roleTask":"Plan","tasks":[{"id":"T1","title":"Implement X","acceptanceCriteria":"Tests pass","status":"pending"}]},…],"pipeline":{"order":["planner","builder","verifier"],"verifyGate":{"verifierRole":"verifier","maxRetries":3}}}} — use crew_pipeline_status / crew_verify / crew_task_update at runtime.'),
