 ...
 */
export declare function resolveRoute(request: RouteOverrides | undefined, config: RouteOverrides): RouteOverrides;
/**
 ...
 */
export declare function roleRouteOverrides(role: {
 ...
 */
export declare function effectiveMaxDepth(requestMax: number | undefined, configMax: number | 'provider-managed' | undefined): number | undefined;
